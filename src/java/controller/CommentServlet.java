...
public class CommentServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (ses.getAttribute("account") != null) {
            ...
            Account user = (Account) ses.getAttribute("account");
            int postId = Integer.parseInt(request.getParameter("postid"));
            //get dd/MM/yyyy
           Date strDate = java.sql.Date.valueOf(LocalDate.now());
            
            DAO dao = new DAO();
            Comment c = new Comment(user.getUserID(), postId,0, comment, strDate);
            dao.insertComment(c);
